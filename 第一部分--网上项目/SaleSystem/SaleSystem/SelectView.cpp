...
void CSelectView::OnInitialUpdate()
{
	...
	m_treeCtrl->InsertItem(TEXT("商品管理"),0,0,NULL);
	m_treeCtrl->InsertItem(TEXT("商品信息"),0,0,NULL);
	m_treeCtrl->InsertItem(TEXT("商品添加"),0,0,NULL);
	m_treeCtrl->InsertItem(TEXT("商品删除"),0,0,NULL);
